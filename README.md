...
This tutorial assumes that you're already familiar with Ruby & Capybara and focuses on using them
with Percy. You'll still be able to follow along if you're not familiar with Ruby & Capybara, but
...
``` shell
$ git clone https://github.com/percy/example-percy-capybara.git
$ cd example-percy-capybara
$ make install
```
...
This will run the app's caCapybrara tests, which contain calls to create Percy snapshots. The snapshots
